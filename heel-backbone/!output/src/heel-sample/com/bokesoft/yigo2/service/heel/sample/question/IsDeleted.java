...
public class IsDeleted implements IExtService {
	Logger _logger = LoggerFactory.getLogger("com.bokesoft.yigo2.service.heel.sample.question.IsDeleted");
	protected DefaultContext _ctx = null;

	@Override
	public Object doCmd(DefaultContext arg0, ArrayList<Object> arg1) throws Throwable {
		_logger.info("Question is deleted？");
		_ctx = arg0;
	...
	protected boolean isDeleted(Integer id) throws Throwable { // Question is deleted?
		IDBManager dbm = _ctx.getDBManager();
		DataTable result = null;
		String sql = "select isdeleted from ts_exam_question_header where oid=? ";
